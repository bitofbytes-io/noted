...
describe('WorkDetailsComponent capability states', () => {
  ...
  it('links the Audiveris project from the playable MusicXML conversion entry', async () => {
    const work = {
      id: 'work-1',
      ...
      editions: [
        {
          ...
          assets: [
            ...
            },
            {
              ...
              contentUrl: '/api/assets/xml-1/content',
              downloadUrl: '/api/assets/xml-1/download',
              playbackValidation: {
                status: 'needs_review',
                issues: [
                  {
                ...
                items: [
                  {
                    ...
                    projectDownloadUrl: '/api/recognition-jobs/job-1/project',
                    createdAt: '2026-07-18T00:00:00Z',
    ...
    await vi.waitFor(() => {
      fixture.detectChanges();
      expect(fixture.nativeElement.textContent).toContain('Download OMR');
    });
    ...
    expect(
      rows[1].querySelector('a[href="/api/recognition-jobs/job-1/project"]')?.textContent?.trim(),
    ).toBe('Download OMR');
  });
});
